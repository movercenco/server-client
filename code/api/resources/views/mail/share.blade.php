...
<td class="header" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 25px 0; text-align: center;">
        <img src="https://mundolingo.org/images/header-logo-color.png" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; align-items: center; max-width: 10%;">
</td>
</tr>
...
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">You've been invited to an event! Here is the message: {{ $userMessage }}</p>
...
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Sincerely,<br>
Mundo Lingo</p>
...
into your web browser: <a href="{{ $url }}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;"></a><a href="{{ $url }}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">{{ $url }}</a></p>
        </td>
    </tr></table>
</td>
                                </tr>
...
<td class="content-cell" align="center" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">© 2017 MundoLingo. All rights reserved.</p>
                </td>
            </tr></table>
</td>
</tr>
